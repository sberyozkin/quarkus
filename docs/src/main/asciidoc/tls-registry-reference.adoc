...
Using a management router is recommended to let Quarkus deal with ACME challenge requests separately to the main application's deployment and security requirements:
