...
public class OidcClientRegistrationBuildStep {
    ...
    //@BuildStep
    //void registerOidcClientRegConfigFactory(BuildProducer<RunTimeConfigBuilderBuildItem> runTimeConfigBuilder) {
    //    runTimeConfigBuilder.produce(new RunTimeConfigBuilderBuildItem(
    //            OidcClientRegistrationConfigSourceFactoryBuilder.class.getName()));
    //}
