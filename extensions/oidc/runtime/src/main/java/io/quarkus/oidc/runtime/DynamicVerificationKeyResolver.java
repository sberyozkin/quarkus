...
public class DynamicVerificationKeyResolver {
    ...
    private static final Set<String> KEY_HEADERS = Set.of(HeaderParameterNames.KEY_ID,
            HeaderParameterNames.X_509_CERT_SHA_256_THUMBPRINT, HeaderParameterNames.X_509_CERT_SHA_1_THUMBPRINT);
    ...
    public Uni<VerificationKeyResolver> resolve(TokenCredential tokenCred) {
        ...
        if (chainResolverFallback != null && headers.containsKey(HeaderParameterNames.X_509_CERT_CHAIN)
        ...
        return client.getJsonWebKeySet(new OidcRequestContextProperties(
                ...
                .onItem().transformToUni(new Function<JsonWebKeySet, Uni<? extends VerificationKeyResolver>>() {
                    ...
                    public Uni<? extends VerificationKeyResolver> apply(JsonWebKeySet jwks) {
                        ...
                        if (newKey == null) {
                            thumbprint = headers.getString(HeaderParameterNames.X_509_CERT_SHA_256_THUMBPRINT);
                            if (thumbprint != null) {
                        ...
                        if (newKey == null) {
                            thumbprint = headers.getString(HeaderParameterNames.X_509_CERT_SHA_1_THUMBPRINT);
                            if (thumbprint != null) {
    ...
    private Key findKeyInTheCache(JsonObject headers) {
        ...
        String thumbprint = headers.getString(HeaderParameterNames.X_509_CERT_SHA_256_THUMBPRINT);
