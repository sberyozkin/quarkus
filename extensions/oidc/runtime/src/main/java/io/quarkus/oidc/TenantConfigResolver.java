 ...
 * <p>
 * If an already resolved tenant configuration must be updated, do not modify it in the resolver because it is not thread-safe.
 * Use {@link OidcTenantConfigBuilder#builder(io.quarkus.oidc.runtime.OidcTenantConfig)} to copy the resolved configuration,
 * modify it as required,
 * and build a new configuration instance instead.
 */
public interface TenantConfigResolver {
     ...
     *         should be chosen unless the resolved tenant configuration is already available.
     */
