...
public class JsonWebKeySet {
    ...
    private void initKeys(String json) {
        io.smallrye.jwt.common.JsonWebKeySet jwkSet;
        try {
            jwkSet = io.smallrye.jwt.common.JsonWebKeySet.parse(json);
    ...
    private static Key extractKey(JsonWebKey jwkKey) throws JsonWebKeyException {
        Key secretKey = jwkKey.secretKey();
        return secretKey != null ? secretKey : jwkKey.publicKey();
    }
